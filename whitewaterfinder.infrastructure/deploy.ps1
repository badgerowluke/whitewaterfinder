...
# Register RPs
$resourceProviders = @("microsoft.cdn","microsoft.insights","microsoft.keyvault","microsoft.operationalinsights","microsoft.storage","microsoft.web","microsoft.operationsmanagement");
